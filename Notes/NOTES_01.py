...
def main():
    ...
    create_filiere(notes_frame, "GI", 0, 0)
    create_filiere(notes_frame, "IID", 0, 1)
    create_filiere(notes_frame, "IRIC", 0, 2)
    create_filiere(notes_frame, "MGSI", 0, 3)
    create_filiere(notes_frame, "GE", 0, 4)
    create_filiere(notes_frame, "GP", 0, 5)
